...
private:
  ...
  std::unordered_set<std::string> shapers; // Benzersiz RealmShaper isimlerini tutar
...
public:
  ...
  int getShaperCount();
  bool addShaper(const std::string& shaperName);  // Shaper ekle
  bool removeShaper(const std::string& shaperName); 
